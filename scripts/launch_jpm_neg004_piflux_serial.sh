#!/usr/bin/env bash
# Launch Eg_Q1 and T2g_Q_xz source-field ED for Jpm=-0.04 (pi-flux QSI), J3=0
set -euo pipefail
...
SCAN_ROOT="twist_qsi_demo/output/jpm_neg004_piflux_j3zero"
...
echo "=== Jpm=-0.04 pi-flux QSI source-field runs ==="
echo "ROOT=$ROOT"
...
echo "Jpm=-0.04 pi-flux campaign complete"
