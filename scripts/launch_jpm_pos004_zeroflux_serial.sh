#!/usr/bin/env bash
# Launch Eg_Q1 source-field ED for Jpm=+0.04 (zero-flux QSI), J3=0
# Purpose: compare zero-flux (Jpm>0) vs pi-flux (Jpm<0) thermal expansion response
set -euo pipefail
...
SCAN_ROOT="twist_qsi_demo/output/jpm_pos004_zeroflux_j3zero"
...
echo "=== Jpm=+0.04 zero-flux QSI source-field runs ==="
echo "ROOT=$ROOT"
...
echo "Jpm=+0.04 zero-flux campaign complete"
