...
Two more characters:
\begin{description}
\item[$Z$, the residue or ``purity''.]  The fraction of a low-energy state
that actually lives in $P$.  At weak coupling $Z\approx0.99$ (states are
...
level with ice weight $Z_n$ appears among the roots of $F$ carrying weight
...
$Z$ & ice purity of a state; $1-Z$ = spinon dressing = the error and
convergence rate of everything approximate\\
