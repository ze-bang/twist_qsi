...
by $0.375K$. All quantities reported at 96 sites therefore refer to
the lowest sector among those tested, and the exhaustive results at
48 and 72 sites --- where the largest sector does contain the ground
state, by an $O(1)K$ margin --- are the evidence that this is the
